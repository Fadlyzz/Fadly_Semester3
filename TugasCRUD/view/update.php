...
if (isset($_GET['edit']) && isset($_GET['survei_id'])) {
    ...
    $query = "SELECT * FROM survei WHERE id = ?";
...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['icon']['error'] == 0) {
        ...
        $query = "UPDATE survei SET judul = ?, link = ? WHERE id = ?";
        $stmt = mysqli_prepare($conn, $query);
        ...
        <div class="row">
            ...
            <div class="col-md-9 mt-4">
                ...
                <div class="form-group">
                    <label for="icon" class="for-label">Icon (leave blank to keep the existing icon):</label>
